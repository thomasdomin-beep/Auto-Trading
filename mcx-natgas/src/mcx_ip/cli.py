...
from mcx_ip.runner import execute_run
...
def main(argv: list[str] | None = None) -> int:
    _setup_logging()
    parser = argparse.ArgumentParser(description="MCX Natural Gas Ideal Premium strategy")
    parser.add_argument(
    ...
    if args.command == "serve-bridge":
        from mcx_ip.bridge import serve
    ...
    if args.command == "schedule":
        if args.with_bridge:
            ...
            from mcx_ip.bridge import serve_in_thread
