...
from sensex_ip.models import CrossoverPair, StrikeRow
    ...
    for i in range(len(chain) - 1):
        ...
        if ce1 > pe1 and ce2 < pe2:
            ...
            pair = CrossoverPair(
                ...
                scrip_ce_a=k1.ce.scrip_id,
                scrip_pe_a=k1.pe.scrip_id,
                scrip_ce_b=k2.ce.scrip_id,
                scrip_pe_b=k2.pe.scrip_id,
            )
...
def compute_support_resistance(
    ...
    s1, s2 = best_below[1], best_above[1]
